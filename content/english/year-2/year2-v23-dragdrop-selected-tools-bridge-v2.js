/* DUDUQ English Year 2 — Drag & Drop selected-choice tools bridge V2
   ...
   - placement autoplay has a separate hidden native trigger using forceRestart,
     so stale audio keys cannot turn autoplay into a stop/toggle action;
   ...
   - option-audio controls remain truly interactive while automatic instruction
     speech is playing, but still respect pause/transition/success locks;
...
(function () {
  ...
  const VERSION = "2.0.9-year2-selected-choice-tools-dd2-placement-force-restart";
...
@media (max-width: 640px) {
  ...
  window.__DUDUQ_YEAR2_DD_SELECTED_TOOLS_V2_BRIDGE__ = Object.freeze({
    ...
    placementAutoplayForceRestartTriggerEnabled: true,
