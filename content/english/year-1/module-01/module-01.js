...
(function () {
  ...
  function baseQuestion(bp, mechanic, metadata, answer, alternatives, audioConfig, adaptation) {
    ...
    return {
      ...
      metadata: {
        ...
        mechanicSelection: {
          selected: mechanic,
          preferenceWeight: mechanic === "target-shooter" ? 100 : mechanic === "matching" ? 94 : mechanic === "bubble-pop" ? 84 : 0,
  ...
  const moduleDefinition = {
    ...
    pedagogicalNotes: {
      ...
      diversity: "At least 3 mechanics used; no single mechanic >70%; Smart Sentence intentionally blocked in Year 1.",
