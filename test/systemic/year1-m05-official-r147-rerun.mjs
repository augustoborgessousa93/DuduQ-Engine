...
if(source.includes("window.DuduQ?.getSession?.totalSteps")||source.includes("window.DuduQ?.getSession?.stepIndex"))throw new Error("Stale M05 getSession property assertion remains.");
