/* DUDUQ TEST CONTENT — BUBBLE POP 1.0.28 SUBCARD PARITY */
(function () {
  "use strict";
  ...
  const moduleDefinition = {
    id: "duduq-test-bubble-pop-1.0.28",
    version: "test-bubble-pop-1.0.28-1",
    ...
    intro: {
      ...
      collectionName: "Bubble Pop 1.0.28",
    ...
    activities: [{
      ...
      questions: [{
        ...
        metadata: {
          screenTitle: "WORDS",
          homologation: {
            mechanicRelease: "1.0.28",
            channel: "homolog-bubble-pop-1.0.28",
  ...
  window.DUDUQ_CONTENT.test.bubblePop1028 = Object.freeze(moduleDefinition);
})();
