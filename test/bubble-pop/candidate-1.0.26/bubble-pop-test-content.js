/* DUDUQ TEST CONTENT — BUBBLE POP 1.0.26 SUBCARD PARITY */
(function () {
  "use strict";
  ...
  const moduleDefinition = {
    id: "duduq-test-bubble-pop-1.0.26",
    version: "test-bubble-pop-1.0.26-1",
    ...
    intro: {
      ...
      collectionName: "Bubble Pop 1.0.26",
    ...
    activities: [{
      ...
      questions: [{
        ...
        metadata: {
          screenTitle: "WORDS",
          homologation: {
            mechanicRelease: "1.0.26",
            channel: "homolog-bubble-pop-1.0.26",
  ...
  window.DUDUQ_CONTENT.test.bubblePop1026 = Object.freeze(moduleDefinition);
})();
