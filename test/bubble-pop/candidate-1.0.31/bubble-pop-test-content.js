/* DUDUQ TEST CONTENT — BUBBLE POP 1.0.31 SUBCARD PARITY */
(function () {
  "use strict";
  ...
  const moduleDefinition = {
    id: "duduq-test-bubble-pop-1.0.31",
    version: "test-bubble-pop-1.0.31-1",
    ...
    intro: {
      ...
      collectionName: "Bubble Pop 1.0.31",
    ...
    activities: [{
      ...
      questions: [{
        ...
        metadata: {
          screenTitle: "WORDS",
          homologation: {
            mechanicRelease: "1.0.31",
            channel: "homolog-bubble-pop-1.0.31",
  ...
  window.DUDUQ_CONTENT.test.bubblePop1031 = Object.freeze(moduleDefinition);
})();
