/* DUDUQ TEST CONTENT — BUBBLE POP 1.0.29 SUBCARD PARITY */
(function () {
  "use strict";
  ...
  const moduleDefinition = {
    id: "duduq-test-bubble-pop-1.0.29",
    version: "test-bubble-pop-1.0.29-1",
    ...
    intro: {
      ...
      collectionName: "Bubble Pop 1.0.29",
    ...
    activities: [{
      ...
      questions: [{
        ...
        metadata: {
          screenTitle: "WORDS",
          homologation: {
            mechanicRelease: "1.0.29",
            channel: "homolog-bubble-pop-1.0.29",
  ...
  window.DUDUQ_CONTENT.test.bubblePop1029 = Object.freeze(moduleDefinition);
})();
