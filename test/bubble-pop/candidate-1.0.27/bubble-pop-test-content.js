/* DUDUQ TEST CONTENT — BUBBLE POP 1.0.27 SUBCARD PARITY */
(function () {
  "use strict";
  ...
  const moduleDefinition = {
    id: "duduq-test-bubble-pop-1.0.27",
    version: "test-bubble-pop-1.0.27-1",
    ...
    intro: {
      ...
      collectionName: "Bubble Pop 1.0.27",
    ...
    activities: [{
      ...
      questions: [{
        ...
        metadata: {
          screenTitle: "WORDS",
          homologation: {
            mechanicRelease: "1.0.27",
            channel: "homolog-bubble-pop-1.0.27",
  ...
  window.DUDUQ_CONTENT.test.bubblePop1027 = Object.freeze(moduleDefinition);
})();
