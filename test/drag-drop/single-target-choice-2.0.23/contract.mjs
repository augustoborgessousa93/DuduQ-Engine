...
// 3) M03 deve entrar pelo canal isolado, declarar o piloto e preparar o patch DD2 antes do loader.
...
expect(
  ...
  "Patch DD2 precisa ser carregado antes do loader para eliminar corrida antes do mount."
);
