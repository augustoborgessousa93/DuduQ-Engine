/* =========================================================
   ...
   Versão 1.6.1 — LEGACY URL TO SMART IMAGE CATALOG
   ========================================================= */

(function () {
  "use strict";

  const VERSION = "1.6.1-legacy-url-catalog";
  ...
  function rewriteLegacyAssetUrl(value) {
    ...
    if (relative.startsWith("Imagens%20Ilustrativa/")) {
      const legacyImageFile = relative.slice("Imagens%20Ilustrativa/".length);
      const intelligentImage = resolveImage(legacyImageFile);
      return intelligentImage || BASE + relative;
    }
