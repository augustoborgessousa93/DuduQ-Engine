/* =========================================================
   ...
   Versão 1.4.0 — INTELLIGENT IMAGE RESOLVER
   ========================================================= */

(function () {
  "use strict";

  const VERSION = "1.4.0-intelligent-images";
  ...
  const INTELLIGENT_IMAGE_CATALOG = Object.freeze([
    ...
    { key: "number-3", file: "tr%C3%AAs%20-%20tree%20-%203.png", aliases: ["3", "three", "tres", "number three", "number 3", "numero tres", "numero 3", "tres three 3", "tres tree 3"] },
