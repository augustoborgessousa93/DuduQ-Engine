/* =========================================================
   ...
   AJUSTE 1.0.3
   - ordem dos alvos usa embaralhamento anti-repetição;
   - IDs corretos permanecem imutáveis;
   - movimento, tempo e conteúdo pedagógico não são alterados.
   ========================================================= */
...
(function () {
  ...
  const RUNTIME_VERSION =
    "2.0.2";
  const RELEASE_PATH =
    "/engine/releases/mechanics/target-shooter/1.0.3/";
  ...
  function antiRepeatIds(
    ...
    const storageKey =
      "duduq:presentation:v2:target-shooter:" +
      key;
    ...
    if (source.length === 2) {
      ...
      for (
        ...
        if (!sameOrder(candidate, previous)) {
          break;
        }
      }
