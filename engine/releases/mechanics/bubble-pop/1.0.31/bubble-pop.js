...
(function () {
  ...
  const SHELL_CSS = "/engine/releases/mechanics/bubble-pop/1.0.31/bubble-pop-shell.css";
  ...
  function mount({
    ...
    iframe.src =
      engineBase +
      "/engine/releases/mechanics/bubble-pop/1.0.31/DUDUQ_BUBBLE_POP.html?" +
      params.toString();
    ...
    function installSubcardParityStyles() {
      try {
        ...
        const stylesheetId = "duduq-bubble-pop-shell-parity-1-0-31";
