/* =========================================================
   ...
   Candidate Release 1.0.5 — Final Shell Alignment

   Escopo exclusivo:
   - centralizar opticamente o ícone do áudio;
   - achatar/arredondar o card de acertos no padrão Target Shooter;
   - alinhar respiros verticais e proporção/largura da arena;
...
(function () {
  ...
  const RUNTIME_PATH = "/engine/releases/mechanics/word-slash/1.0.5/";
  ...
  function installShellParity(html) {
    ...
    const css = `
<style id="duduq-word-slash-1-0-5-shell-parity">
/* Paridade visual final com Target Shooter 1.0.21. Nenhuma regra funcional é alterada. */
.duduq-ws-surface {
  width: 100% !important;
...
/* Dashboard mais achatado e arredondado, como os chips do Target Shooter. */
.duduq-ws-dashboard {
  margin: 0 !important;
  gap: 10px !important;
...
.duduq-ws-stat {
  ...
  border-radius: 999px !important;
  background: #fff !important;
  box-shadow: 0 3px 0 #B8C5D6 !important;
  font-size: 14px !important;
  line-height: 1 !important;
}
.duduq-ws-stat strong {
  font-size: 17px !important;
  line-height: 1 !important;
}
/* Arena usa a largura útil do subcard, com proporção próxima ao Target Shooter. */
.duduq-ws-arena {
  width: 100% !important;
  min-height: clamp(330px, 48vh, 460px) !important;
