/* =========================================================
   ...
   Candidate Release 1.0.6 — Shell Geometry + Glass Arena

   Escopo exclusivo:
   - padronizar espessuras, sombras e respiros com Target Shooter 1.0.21;
   - preservar o botão/ícone de áudio já homologado em 1.0.5;
   - impedir a arena de encostar no rodapé;
   - refinar o subcard/arena com acabamento de vidro brilhante leve;
...
(function () {
  ...
  const RUNTIME_PATH = "/engine/releases/mechanics/word-slash/1.0.6/";
  ...
  function installShellParity(html) {
    ...
    const css = `
<style id="duduq-word-slash-1-0-6-shell-parity">
/* Camada FINAL da cascata: shell alinhado à Target Shooter 1.0.21.
...
html body #root .duduq-engine-stage .duduq-ws-audio::before {
  ...
  background: center / 23px 23px no-repeat url("data:image/svg+xml;base64,") !important;
...
html body #root .duduq-engine-stage .duduq-ws-arena {
  ...
  background: radial-gradient(circle at 18% 14%, rgba(255,255,255,.92) 0 3%, rgba(255,255,255,.28) 19%, transparent 38%), radial-gradient(circle at 82% 76%, rgba(177,230,242,.18) 0 13%, transparent 36%), linear-gradient(145deg, rgba(255,255,255,.82) 0%, rgba(245,251,255,.72) 38%, rgba(227,244,250,.58) 100%) !important;
...
html body #root .duduq-engine-stage .duduq-ws-background-layer {
  background: linear-gradient(112deg, transparent 0 18%, rgba(255,255,255,.28) 22%, transparent 31%), radial-gradient(circle at 20% 24%, rgba(255,255,255,.42) 0 1px, transparent 2px), radial-gradient(circle at 72% 68%, rgba(149,205,224,.14) 0 1px, transparent 2px) !important;
    ...
    metadata: {
      ...
      routerProfile: {
        ...
        metadata: {
          ...
          shellParity: "glass-aligned-1.0.6"
        },
