/* =========================================================
   ...
   Candidate Release 1.0.4 — Final Shell Parity with Target Shooter

   Objetivos:
   - preservar a compatibilidade funcional aprovada na 1.0.2/1.0.3;
   - refinar somente a casca visual;
   - melhorar respiros entre enunciado, status e arena;
   - usar botão e ícone de áudio visualmente idênticos à Target Shooter 1.0.21;
   - preservar corte, física, spawn, velocidade, score, progressão e completion flow;
   - manter Canary e módulos oficiais intocados durante a homologação.
   ========================================================= */
(function () {
  "use strict";
  ...
  const RUNTIME_PATH = "/engine/releases/mechanics/word-slash/1.0.4/";
  ...
  function installShellParity(html) {
    ...
    const css = `
<style id="duduq-word-slash-1-0-4-shell-parity">
/* Somente casca visual. Referência literal: Target Shooter 1.0.21. */
.duduq-ws-surface {
...
.duduq-ws-instruction {
  ...
  box-shadow: 0 4px 0 #B8C5D6, 0 10px 20px rgba(31,65,99,.07) !important;
}
...
.duduq-ws-audio:hover:not(:disabled) { filter: brightness(1.05) !important; }
.duduq-ws-audio:active:not(:disabled) {
  transform: translateY(4px) !important;
  box-shadow: 0 1px 0 #064A92, 0 3px 7px rgba(9,103,201,.13) !important;
}
.duduq-ws-audio:focus-visible {
  outline: 4px solid #111827 !important;
  outline-offset: 4px !important;
}
/* Target Shooter permanece azul durante a reprodução; a Word Slash segue o mesmo padrão. */
...
/* Respiros entre enunciado, status e arena, sem alterar a geometria funcional da arena. */
.duduq-ws-dashboard { margin: 2px 0 1px !important; }
.duduq-ws-arena { margin-top: 1px !important; }
