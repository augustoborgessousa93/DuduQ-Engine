/* =========================================================
   DUDUQ MECHANIC — SMART SENTENCE 4.0.0
   TARGET SHOOTER SHELL / MODULAR LANGUAGE ENGINE
...
.duduq-smart-ts-workspace {
  flex: 0 0 auto;
  width: min(900px, 100%);
  min-height: clamp(105px, 17vh, 158px);
  display: flex;
  flex-wrap: wrap;
...
(function () {
  ...
  function adaptContent(content) {
    ...
    if (content.mechanicVersion !== "4.0.0") {
      throw new Error(
        "Conteúdo " + content.id +
        " usa smart-sentence@" + content.mechanicVersion +
        "; runtime disponível: 4.0.0."
      );
    }
  ...
  function SmartSentenceTargetShell(props) {
    ...
    var stateCombo = useState(0);
    var combo = stateCombo[0];
    var setCombo = stateCombo[1];
    ...
    var requiredCount = Math.max(1, question.answer.length);
    var filledCount = Math.min(requiredCount, answerValues.length);
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        /* EXACT TARGET SHOOTER STATUS */
        React.createElement(
          "div",
          {
            className: "duduq-ts-status",
            "aria-label": "Resumo da rodada"
          },
          React.createElement(
            "span",
            {
              className: "duduq-ts-chip"
            },
            "🎯 Alvos ",
            React.createElement(
              "strong",
  ...
  try {
    ...
    if (
      ...
      !api.DRAG_DROP_UNIVERSAL_REGISTRY
    ) {
      throw new Error(
        "Runtime Target Shooter não expôs o Host universal esperado."
      );
    }
    ...
    var mechanics = Object.assign(
      ...
      api.DRAG_DROP_UNIVERSAL_REGISTRY,
      {
        "smart-sentence@4.0.0": registration
      }
    );
    ...
    var mascotAssets = {
      idle: {
        src:
          "https://raw.githubusercontent.com/augustoborgessousa93/Drag-Drop/main/DUDUQ_IDLE.png",
        alt:
          "Mascote DuduQ aguardando e pronto para ajudar."
      },
      success: {
        src:
          "https://raw.githubusercontent.com/augustoborgessousa93/Drag-Drop/main/DUDUQ_ACERTO.png",
        alt:
          "Mascote DuduQ comemorando uma resposta correta."
      },
      retry: {
        src:
          "https://raw.githubusercontent.com/augustoborgessousa93/Drag-Drop/main/DUDUQ_ERRO.png",
        alt:
      ...
      transition: {
        src:
          "https://raw.githubusercontent.com/augustoborgessousa93/Drag-Drop/main/DUDUQ_IDLE.png",
        alt:
          "Mascote DuduQ preparando a próxima etapa."
      },
      complete: {
        src:
          "https://raw.githubusercontent.com/augustoborgessousa93/Drag-Drop/main/Duduq_Li%C3%A7%C3%A3o%20concluida.png",
        alt:
          "Mascote DuduQ celebrando a conclusão da lição."
      }
    };
