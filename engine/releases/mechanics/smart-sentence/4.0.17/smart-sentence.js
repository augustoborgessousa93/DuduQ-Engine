/* =========================================================
   DUDUQ MECHANIC — SMART SENTENCE 4.0.17
...
(function () {
  ...
  function adaptContent(content) {
    ...
    if (content.mechanicVersion !== "4.0.17") {
      throw new Error(
        "Conteúdo " + content.id +
        " usa smart-sentence@" + content.mechanicVersion +
        "; runtime disponível: 4.0.17."
      );
    }
  ...
  try {
    ...
    */
    var mechanics = {
      "smart-sentence@4.0.17": registration
    };
    var mascotAssets = {
      idle: {
