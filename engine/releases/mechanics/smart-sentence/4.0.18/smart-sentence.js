/* =========================================================
   DUDUQ MECHANIC — SMART SENTENCE 4.0.18
...
.duduq-ts-arena[data-smart-sentence-shell="true"] .duduq-ts-cloud[data-cloud="b"] {
  display: none !important;
}
...
(function () {
  ...
  function adaptContent(content) {
    ...
    if (content.mechanicVersion !== "4.0.18") {
      throw new Error(
        "Conteúdo " + content.id +
        " usa smart-sentence@" + content.mechanicVersion +
        "; runtime disponível: 4.0.18."
      );
    }
  ...
  try {
    ...
    */
    var mechanics = {
      "smart-sentence@4.0.18": registration
    };
    var mascotAssets = {
      idle: {
