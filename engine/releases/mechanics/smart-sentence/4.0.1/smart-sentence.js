/* =========================================================
   DUDUQ MECHANIC — SMART SENTENCE 4.0.1
   TARGET SHOOTER SHELL / REGISTRY BRIDGE FIX / MODULAR LANGUAGE ENGINE
...
(function () {
  ...
  function adaptContent(content) {
    ...
    if (content.mechanicVersion !== "4.0.1") {
      throw new Error(
        "Conteúdo " + content.id +
        " usa smart-sentence@" + content.mechanicVersion +
        "; runtime disponível: 4.0.1."
      );
    }
  ...
  try {
    ...
    */
    var mechanics = {
      "smart-sentence@4.0.1": registration
    };
