/* =========================================================
   DUDUQ MECHANIC — SMART SENTENCE 4.0.2
   TARGET SHOOTER SHELL / FINE TUNING / MODULAR LANGUAGE ENGINE
...
(function () {
  ...
  function adaptContent(content) {
    ...
    if (content.mechanicVersion !== "4.0.2") {
      throw new Error(
        "Conteúdo " + content.id +
        " usa smart-sentence@" + content.mechanicVersion +
        "; runtime disponível: 4.0.2."
      );
    }
  ...
  try {
    ...
    */
    var mechanics = {
      "smart-sentence@4.0.2": registration
    };
