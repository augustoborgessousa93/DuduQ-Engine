/* =========================================================
   DUDUQ MECHANIC — SMART SENTENCE 4.0.5
...
(function () {
  ...
  function adaptContent(content) {
    ...
    if (content.mechanicVersion !== "4.0.5") {
      throw new Error(
        "Conteúdo " + content.id +
        " usa smart-sentence@" + content.mechanicVersion +
        "; runtime disponível: 4.0.5."
      );
    }
  ...
  try {
    ...
    */
    var mechanics = {
      "smart-sentence@4.0.5": registration
    };
    var mascotAssets = {
      idle: {
