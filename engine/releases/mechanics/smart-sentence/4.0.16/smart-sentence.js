/* =========================================================
   DUDUQ MECHANIC — SMART SENTENCE 4.0.16
...
/* Remove o brilho/segundo sol extra e mantém apenas um sol fixo no céu. */
...
(function () {
  ...
  function adaptContent(content) {
    ...
    if (content.mechanicVersion !== "4.0.16") {
      throw new Error(
        "Conteúdo " + content.id +
        " usa smart-sentence@" + content.mechanicVersion +
        "; runtime disponível: 4.0.16."
      );
    }
  ...
  try {
    ...
    */
    var mechanics = {
      "smart-sentence@4.0.16": registration
    };
    var mascotAssets = {
      idle: {
