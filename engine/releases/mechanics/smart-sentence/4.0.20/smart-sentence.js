/* =========================================================
   DUDUQ MECHANIC — SMART SENTENCE 4.0.20
...
/* SMART-ONLY SKY CLEANUP — fonte real dos círculos:
   o Target Shooter desenha dois círculos brancos como radial-gradient
   diretamente no background da .duduq-ts-arena. Mantemos a mesma
   gradação azul do Target, removendo apenas os radial-gradients e o
   brilho verde inferior. Nuvens e sparkles permanecem intactos. */
.duduq-ts-arena[data-smart-sentence-shell="true"] {
...
(function () {
  ...
  function adaptContent(content) {
    ...
    if (content.mechanicVersion !== "4.0.20") {
      throw new Error(
        "Conteúdo " + content.id +
        " usa smart-sentence@" + content.mechanicVersion +
        "; runtime disponível: 4.0.20."
      );
    }
  ...
  try {
    ...
    */
    var mechanics = {
      "smart-sentence@4.0.20": registration
    };
    var mascotAssets = {
      idle: {
