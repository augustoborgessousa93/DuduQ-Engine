/* =========================================================
   DUDUQ MECHANIC — SMART SENTENCE 4.0.7
...
.duduq-ts-audio-button[data-playing="true"],
.duduq-ts-audio-button[data-playing="true"]:disabled {
  border-color: #58A700 !important;
  background: linear-gradient(180deg,#8FEA3B 0%,#6BCB1F 64%,#58A700 100%) !important;
  color: #FFFFFF !important;
  box-shadow:
    0 4px 0 #58A700,
    0 0 0 4px rgba(88,167,0,.18),
...
.duduq-ts-audio-shell[data-playing="true"] .duduq-ts-audio-waves .duduq-ts-audio-wave {
  background: rgba(88,167,0,.95) !important;
}
...
(function () {
  ...
  function adaptContent(content) {
    ...
    if (content.mechanicVersion !== "4.0.7") {
      throw new Error(
        "Conteúdo " + content.id +
        " usa smart-sentence@" + content.mechanicVersion +
        "; runtime disponível: 4.0.7."
      );
    }
  ...
  try {
    ...
    */
    var mechanics = {
      "smart-sentence@4.0.7": registration
    };
    var mascotAssets = {
      idle: {
