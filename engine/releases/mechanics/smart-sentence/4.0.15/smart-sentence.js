/* =========================================================
   DUDUQ MECHANIC — SMART SENTENCE 4.0.15
...
/* Remove o brilho/segundo sol extra, mantendo apenas um elemento solar no céu. */
...
(function () {
  ...
  function adaptContent(content) {
    ...
    if (content.mechanicVersion !== "4.0.15") {
      throw new Error(
        "Conteúdo " + content.id +
        " usa smart-sentence@" + content.mechanicVersion +
        "; runtime disponível: 4.0.15."
      );
    }
  ...
  try {
    ...
    */
    var mechanics = {
      "smart-sentence@4.0.15": registration
    };
    var mascotAssets = {
      idle: {
