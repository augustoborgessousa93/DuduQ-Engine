...
if(process.argv[1]?.endsWith("duduq-update-core.mjs")){execute(process.argv.slice(2)).then(r=>console.log(JSON.stringify(r,null,2))).catch(e=>{console.error(e.message);process.exitCode=2})}
